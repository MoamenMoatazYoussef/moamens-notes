...
**Spring Data JPA** <br/>
It's a project that'll help us create a generic DAO, we just pass the entity type and primary key, and it'll give us CRUD apps for free :) <br/>
...
We don't even need an implementation class :) <br/>
...
```
That's it, we don't need to create a class :)
...
Finally, remove @Transactional, JpaRepository provides it by default :)
``` Java
@Service
public class EmployeeServiceImpl implements EmployeeService {
...
```
Refresh localhost:8080/api/employees, see the results :)
